...
return new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$rotation,pucks.util.relative_position__GT_rotation(cljs.core.cst$kw$velocity.cljs$core$IFn$_invoke$arity$1(p)),cljs.core.cst$kw$transfer,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__4523__auto__ = (function pucks$agents$torpedo$torpedo_proposals_$_iter__11386(s__11387){
return (new cljs.core.LazySeq(null,(function (){
var s__11387__$1 = s__11387;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__11387__$1);
if(temp__5735__auto__){
var s__11387__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__11387__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__11387__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__11389 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__11388 = (0);
while(true){
if((i__11388 < size__4522__auto__)){
var victim = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__11388);
cljs.core.chunk_append(b__11389,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$self,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(p),cljs.core.cst$kw$other,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(victim),cljs.core.cst$kw$bid,cljs.core.PersistentArrayMap.EMPTY,cljs.core.cst$kw$ask,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$energy,1.0], null)], null));

var G__11390 = (i__11388 + (1));
i__11388 = G__11390;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__11389),pucks$agents$torpedo$torpedo_proposals_$_iter__11386(cljs.core.chunk_rest(s__11387__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__11389),null);
}
} else {
var victim = cljs.core.first(s__11387__$2);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$self,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(p),cljs.core.cst$kw$other,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(victim),cljs.core.cst$kw$bid,cljs.core.PersistentArrayMap.EMPTY,cljs.core.cst$kw$ask,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$energy,1.0], null)], null),pucks$agents$torpedo$torpedo_proposals_$_iter__11386(cljs.core.rest(s__11387__$2)));
}
} else {
return null;
}
